...
const formData = reactive({
  ...
  status: 'active' as CustomerStatus, // Only used when editing
  address: '',
  state: '',
});
...
function handleEdit(customer: Customer) {
  ...
  formData.business_name = customer.business_name;
  formData.contact_person_first_name = customer.contact_person_first_name;
  formData.contact_person_last_name = customer.contact_person_last_name;
  formData.contact_person_email = customer.contact_person_email || '';
  formData.contact_person_phone_number = customer.contact_person_phone_number;
...
async function handleSubmit() {
  ...
  try {
    ...
    if (editingCustomer.value) {
      ...
      await configStore.updateCustomer(editingCustomer.value.id, submitData);
      alertStore.success('Customer updated successfully');
    } else {
      await configStore.createCustomer(submitData);
