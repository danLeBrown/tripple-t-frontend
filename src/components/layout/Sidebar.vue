<template>
  <aside class="w-64 bg-gray-900 text-white min-h-screen">
    ...
    <nav class="mt-8">
      ...
      <div class="mt-4">
        <button @click="isConfigurationOpen = !isConfigurationOpen"
        ...
        <Transition enter-active-class="transition-all duration-200 ease-out" enter-from-class="opacity-0 max-h-0"
          ...
          <div v-show="isConfigurationOpen" class="overflow-hidden">
            <router-link to="/configuration/products"
            ...
            <router-link to="/configuration/colors"
              class="flex items-center px-6 py-3 pl-12 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors"
              active-class="bg-gray-800 text-white">
              <SwatchIcon class="w-5 h-5 mr-3" />
              Colors
            </router-link>
            <router-link to="/configuration/sizes"
              class="flex items-center px-6 py-3 pl-12 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors"
              active-class="bg-gray-800 text-white">
              <ArrowsPointingOutIcon class="w-5 h-5 mr-3" />
              Sizes
            </router-link>
            <router-link to="/configuration/units"
              class="flex items-center px-6 py-3 pl-12 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors"
              active-class="bg-gray-800 text-white">
      ...
      <div class="mt-4">
        <button @click="isThirdPartiesOpen = !isThirdPartiesOpen"
          class="w-full flex items-center justify-between px-6 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider hover:bg-gray-800 transition-colors">
          <div class="flex items-center">
        ...
        <Transition enter-active-class="transition-all duration-200 ease-out" enter-from-class="opacity-0 max-h-0"
          ...
          <div v-show="isThirdPartiesOpen" class="overflow-hidden">
            <router-link to="/third-parties/suppliers"
              class="flex items-center px-6 py-3 pl-12 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors"
              active-class="bg-gray-800 text-white">
              <TruckIcon class="w-5 h-5 mr-3" />
              Suppliers
            </router-link>
            <router-link to="/third-parties/customers"
              class="flex items-center px-6 py-3 pl-12 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors"
              active-class="bg-gray-800 text-white">
